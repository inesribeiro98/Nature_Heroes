...
<body>
  ...
  <div class="caixa">
    ...
    <div class="whitepart">
      ...
      <!-- Detalhos do trabalho  -->
      <h2> Detalhes do Projeto </h2>
      <div class="flex-container">

        <div class="about">
          <p class="centra" > <b> Resolução Utilizada</b> </p>
          <p class="centra">  1366 x 625 </p>
        </div>

        <div class="about">
          <p class="centra"> <b> Browser</b> </p>
          <p class="centra">  Google Chrome </p>
        </div>
      ...
      <div class="flex-container" style="justify-content:center;">
        ...
        <div class="about" style="padding:30px;">
          <img src="../../Images/ines.jpg">
        </div>

        <div class="about" style="padding:30px;">
          <p class="centra"> Inês Pereira Cabral Ribeiro </p>
          <p class="centra">  up201603573@fe.up.pt </p>
          <br>
          <p class="centra"> Maria Manuel Saturnino Silva Serôdio  </p>
          <p class="centra">  up201606947@fe.up.pt </p>
        </div>
      ...
      <div class="flex-container">
        ...
        <div class="about">
          <a href="../../Documents/Code.zip" download="Code_InesRibeiro_MariaSerodio">
          <img  class="download" src="../../Images/Icons/zip.png" alt="ZIP">  </a>
        </div>

        <div class="about">
          <a href="../../Documents/Mockup_InesRibeiro_MariaSerodio.pptx" download="Mockup_InesRibeiro_MariaSerodio">
          <img  class="download" src="../../Images/Icons/powerpoint.png" alt="Mockup"> </a>
        </div>

        <div class="about">
          <a href="../../Documents/CSS.zip" download="CSS_InesRibeiro_MariaSerodio">
          <img class="download" src="../../Images/Icons/css.png" alt="CSS"> </a>
        </div>
